...
# Sample sizes critical for COLOC analysis
...
colnames(test_rs) <- c(
    ...
    "PP.H4.abf",              
    "sqtl_variant_P_most",    
    "sqtl_variant_id_merge",  
    "sqtl_variant_P_merge",   
    "GWAS_variant_id_most",   
    "GWAS_variant_P_most",    
    "GWAS_variant_id_merge",  
    "GWAS_variant_P_merge"    
)
