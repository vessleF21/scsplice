...
max_y          <- ceiling(max(data_filtered$TotalReadCount) / 5000) * 5000
...
ggsave("splic_read_boxplot_sorted.pdf", plot = p, width = 12, height = 5)
ggsave("splic_read_boxplot_sorted.png", plot = p, width = 12, height = 5, dpi = 300)
